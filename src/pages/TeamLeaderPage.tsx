                            ...
                            <div className="grid grid-cols-2 gap-4"> 
                                <div className="space-y-1"> 
                                    ...
                                    <input 
                                        ...
                                        className={`w-full px-4 py-3 border rounded-xl text-sm outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 disabled:opacity-50 ${
                                            errors.name ? 'border-red-300 bg-red-50' : 'bg-slate-50 border-slate-200'
                                        }`}
                                ...
                                <div className="space-y-1"> 
                                    ...
                                    <input 
                                        ...
                                        disabled={!!editingParticipant || isSubmitting}
                                        className={`w-full px-4 py-3 border rounded-xl text-sm outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 disabled:opacity-50 ${
                                            errors.chestNumber ? 'border-red-300 bg-red-50' : 'bg-slate-50 border-slate-200'
                                        }`}
