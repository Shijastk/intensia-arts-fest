...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = "w-full py-3.5 px-4 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2.5 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.99] select-none";
  ...
  const variants = {
    ...
    google: "bg-white hover:bg-slate-50 text-slate-700 border border-slate-200"
  };
